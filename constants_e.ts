...
export const PREMIER_LEAGUE_TEAMS: Team[] = [
  createTeam('MCI', 'Man City', LeagueLevel.PREMIER_LEAGUE, 95, 94, 93, 'bg-sky-500', '🔵', [
    ...
    { name: 'Julian Alvarez', position: 'FWD', rating: 89, age: 25 },
    { name: 'Savinho', position: 'FWD', rating: 88, age: 21 },
  ...
  createTeam('CHE', 'Chelsea', LeagueLevel.PREMIER_LEAGUE, 91, 90, 88, 'bg-blue-600', '🔵', [
    ...
    { name: 'Reece James', position: 'DEF', rating: 89, age: 25 },
    { name: 'Nicolas Jackson', position: 'FWD', rating: 88, age: 24 },
    { name: 'Pedro Neto', position: 'FWD', rating: 87, age: 25 },
    { name: 'Levi Colwill', position: 'DEF', rating: 87, age: 22 },
    { name: 'Christopher Nkunku', position: 'FWD', rating: 88, age: 27 },
    { name: 'Wesley Fofana', position: 'DEF', rating: 87, age: 24 },
    { name: 'Malo Gusto', position: 'DEF', rating: 86, age: 22 },
    { name: 'Romeo Lavia', position: 'MID', rating: 86, age: 21 },
    { name: 'Marc Cucurella', position: 'DEF', rating: 85, age: 27 },
    { name: 'Jadon Sancho', position: 'FWD', rating: 86, age: 25 },
  ...
  createTeam('AVL', 'Aston Villa', LeagueLevel.PREMIER_LEAGUE, 88, 87, 87, 'bg-claret-600 text-white', '🟣', [
    ...
    { name: 'Douglas Luiz', position: 'MID', rating: 86, age: 27 },
  ...
  createTeam('TOT', 'Tottenham', LeagueLevel.PREMIER_LEAGUE, 88, 87, 86, 'bg-white', '⚪', [
    ...
    { name: 'Dominic Solanke', position: 'FWD', rating: 86, age: 28 },
    { name: 'Yves Bissouma', position: 'MID', rating: 86, age: 29 },
    { name: 'Cristian Romero', position: 'DEF', rating: 87, age: 27 },
    { name: 'Dejan Kulusevski', position: 'FWD', rating: 86, age: 25 },
    { name: 'Guglielmo Vicario', position: 'GK', rating: 86, age: 29 },
    { name: 'Brennan Johnson', position: 'FWD', rating: 85, age: 24 },
    { name: 'Destiny Udogie', position: 'DEF', rating: 85, age: 22 },
  ...
  createTeam('MUN', 'Man United', LeagueLevel.PREMIER_LEAGUE, 87, 86, 85, 'bg-red-700', '🔴', [
    ...
    { name: 'Alejandro Garnacho', position: 'FWD', rating: 87, age: 21 },
    { name: 'Marcus Rashford', position: 'FWD', rating: 86, age: 28 },
    { name: 'Kobbie Mainoo', position: 'MID', rating: 86, age: 20 },
    { name: 'Diogo Dalot', position: 'DEF', rating: 85, age: 26 },
    { name: 'André Onana', position: 'GK', rating: 85, age: 29 },
    { name: 'Mason Mount', position: 'MID', rating: 84, age: 26 },
    { name: 'Harry Maguire', position: 'DEF', rating: 84, age: 32 },
    { name: 'Joshua Zirkzee', position: 'FWD', rating: 84, age: 24 },
  ...
  createTeam('CRY', 'Crystal Palace', LeagueLevel.PREMIER_LEAGUE, 84, 84, 84, 'bg-blue-600 text-red-600', '🔵🔴', [
    ...
    { name: 'Cheick Doucouré', position: 'MID', rating: 83, age: 25 },
    { name: 'Daichi Kamada', position: 'MID', rating: 82, age: 29 },
    { name: 'Chris Richards', position: 'DEF', rating: 82, age: 25 },
    { name: 'Jefferson Lerma', position: 'MID', rating: 83, age: 31 },
    { name: 'Daniel Muñoz', position: 'DEF', rating: 82, age: 29 }
  ]),
  ...
  createTeam('BOU', 'Bournemouth', LeagueLevel.PREMIER_LEAGUE, 83, 83, 82, 'bg-red-800 text-black', '🍒', [
    ...
    { name: 'Lewis Cook', position: 'MID', rating: 82, age: 28 },
    { name: 'Tyler Adams', position: 'MID', rating: 82, age: 26 },
    ...
    { name: 'Alex Scott', position: 'MID', rating: 81, age: 22 },
  ...
  createTeam('BRE', 'Brentford', LeagueLevel.PREMIER_LEAGUE, 83, 82, 82, 'bg-red-600 text-white', '🐝', [
    { name: 'Ivan Toney', position: 'FWD', rating: 86, age: 29 },
    { name: 'Bryan Mbeumo', position: 'FWD', rating: 85, age: 26 },
    { name: 'Yoane Wissa', position: 'FWD', rating: 84, age: 29 },
    { name: 'Christian Nørgaard', position: 'MID', rating: 83, age: 31 },
    { name: 'Rico Henry', position: 'DEF', rating: 83, age: 28 },
  ...
  createTeam('WOL', 'Wolves', LeagueLevel.PREMIER_LEAGUE, 82, 82, 82, 'bg-yellow-600 text-black', '🐺', [
    ...
    { name: 'Pedro Neto', position: 'FWD', rating: 85, age: 25 },
  ...
  createTeam('FUL', 'Fulham', LeagueLevel.PREMIER_LEAGUE, 82, 82, 82, 'bg-white text-black', '⚪⚫', [
    ...
    { name: 'Antonee Robinson', position: 'DEF', rating: 83, age: 28 },
    ...
    { name: 'Alex Iwobi', position: 'MID', rating: 82, age: 29 },
    { name: 'Willian', position: 'FWD', rating: 81, age: 37 },
  ...
  createTeam('EVE', 'Everton', LeagueLevel.PREMIER_LEAGUE, 82, 81, 83, 'bg-blue-700', '🔵', [
    ...
    { name: 'Ilman Ndiaye', position: 'FWD', rating: 81, age: 25 },
  ...
  createTeam('BUR', 'Burnley', LeagueLevel.PREMIER_LEAGUE, 84, 83, 84, 'bg-claret-500', '⚔️', [ // Promoted
    ...
    { name: 'Han-Noah Massengo', position: 'MID', rating: 80, age: 24 },
    { name: 'Zeki Amdouni', position: 'FWD', rating: 81, age: 24 },
    { name: 'Mike Trésor', position: 'FWD', rating: 80, age: 26 },
...
export const CHAMPIONSHIP_TEAMS: Team[] = [
  createTeam('LEI', 'Leicester City', LeagueLevel.CHAMPIONSHIP, 83, 82, 81, 'bg-blue-600', '🦊', [
  ...
  createTeam('IPS', 'Ipswich Town', LeagueLevel.CHAMPIONSHIP, 80, 79, 79, 'bg-blue-500', '🚜', [
    { name: 'Leif Davis', position: 'DEF', rating: 81, age: 25 },
    { name: 'Sam Morsy', position: 'MID', rating: 80, age: 34 },
    { name: 'Omari Hutchinson', position: 'FWD', rating: 80, age: 22 },
    ...
    { name: 'Wes Burns', position: 'FWD', rating: 78, age: 30 },
  ...
  createTeam('COV', 'Coventry City', LeagueLevel.CHAMPIONSHIP, 81, 81, 80, 'bg-sky-500', '🔵', [
    ...
    { name: 'Josh Eccles', position: 'MID', rating: 79, age: 25 },
  ...
  createTeam('HUL', 'Hull City', LeagueLevel.CHAMPIONSHIP, 78, 78, 78, 'bg-orange-500 text-black', '🟠⚫', [
    ...
    { name: 'Oscar Estupinan', position: 'FWD', rating: 78, age: 28 },
  ...
  createTeam('MIL', 'Millwall', LeagueLevel.CHAMPIONSHIP, 78, 77, 79, 'bg-blue-800', '🔵', [
    ...
    { name: 'Duncan Watmore', position: 'FWD', rating: 78, age: 31 },
  ...
  createTeam('CAR', 'Cardiff City', LeagueLevel.CHAMPIONSHIP, 77, 77, 77, 'bg-blue-700', '🔵', [
    ...
    { name: 'Anwar El Ghazi', position: 'FWD', rating: 78, age: 30 },
    { name: 'Jak Alnwick', position: 'GK', rating: 77, age: 32 },
    { name: 'Joe Ralls', position: 'MID', rating: 77, age: 32 },
    { name: 'Jamilu Collins', position: 'DEF', rating: 77, age: 31 },
    { name: 'Dimitrios Goutas', position: 'DEF', rating: 77, age: 31 },
    { name: 'Rubin Colwill', position: 'MID', rating: 77, age: 23 },
  ...
  createTeam('BLA', 'Blackburn Rovers', LeagueLevel.CHAMPIONSHIP, 77, 77, 76, 'bg-blue-500 text-white', '🔵⚪', [
    ...
    { name: 'Yasin Ayari', position: 'MID', rating: 76, age: 22 },
  ...
  createTeam('PRE', 'Preston North End', LeagueLevel.CHAMPIONSHIP, 76, 76, 76, 'bg-white text-blue-600', '⚪🔵', [
    ...
    { name: 'Emil Riis', position: 'FWD', rating: 76, age: 27 },
